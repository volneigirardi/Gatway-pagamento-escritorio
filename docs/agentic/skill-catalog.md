...
| `database-change`         | Plan and review a DB change              | user/model | read, grep, glob, exec       | No prod migrations     |
| `database-review`         | Review schema/migrations/queries         | user/model | read, grep, glob, exec       | Read-only              |
